...
HXLINE( 118)				::haxe::Log_obj::trace((((HX_("version online: ",01,48,fa,0b) + ::TitleState_obj::updateVersion) + HX_(", your version: ",85,c4,81,a1)) + curVersion),::hx::SourceInfo(HX_("source_siblings/TitleState.hx",6b,08,a4,8b),118,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
HXLINE( 119)				if ((::TitleState_obj::updateVersion != curVersion)) {
HXLINE( 120)					::haxe::Log_obj::trace(HX_("versions arent matching!",f9,fc,92,ec),::hx::SourceInfo(HX_("source_siblings/TitleState.hx",6b,08,a4,8b),120,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
...
HXLINE( 126)				::haxe::Log_obj::trace((HX_("error: ",6e,80,0a,ea) + error),::hx::SourceInfo(HX_("source_siblings/TitleState.hx",6b,08,a4,8b),126,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 111)			::haxe::Log_obj::trace(HX_("checking for update",86,83,c8,0b),::hx::SourceInfo(HX_("source_siblings/TitleState.hx",6b,08,a4,8b),111,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
