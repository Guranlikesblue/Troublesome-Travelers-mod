...
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_35_unlockAchievement,"Achievements","unlockAchievement",0xddbd5e61,"Achievements.unlockAchievement","Achievements.hx",35,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_41_isAchievementUnlocked,"Achievements","isAchievementUnlocked",0x1e700b3e,"Achievements.isAchievementUnlocked","Achievements.hx",41,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_48_getAchievementIndex,"Achievements","getAchievementIndex",0x4a8ffcaf,"Achievements.getAchievementIndex","Achievements.hx",48,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_58_loadAchievements,"Achievements","loadAchievements",0x7629cad4,"Achievements.loadAchievements","Achievements.hx",58,0xf249f7fa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_34_boot,"Achievements","boot",0x8eb5af9c,"Achievements.boot","Achievements.hx",34,0xf249f7fa)
...
void Achievements_obj::unlockAchievement(::String name){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_35_unlockAchievement)
HXLINE(  37)		::Achievements_obj::achievementsMap->set(name,true);
HXLINE(  38)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  38)		_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
            	}
...
bool Achievements_obj::isAchievementUnlocked(::String name){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_41_isAchievementUnlocked)
HXLINE(  42)		bool _hx_tmp;
HXDLIN(  42)		if (::Achievements_obj::achievementsMap->exists(name)) {
HXLINE(  42)			_hx_tmp = ::Achievements_obj::achievementsMap->get_bool(name);
            		}
            		else {
...
int Achievements_obj::getAchievementIndex(::String name){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_48_getAchievementIndex)
HXLINE(  49)		{
HXLINE(  49)			int _g = 0;
HXDLIN(  49)			int _g1 = ::Achievements_obj::achievementsStuff->get_length();
HXDLIN(  49)			while((_g < _g1)){
HXLINE(  49)				_g = (_g + 1);
HXDLIN(  49)				int i = (_g - 1);
HXLINE(  50)				if (::hx::IsEq( ::Achievements_obj::achievementsStuff->__get(i)->__GetItem(2),name )) {
HXLINE(  51)					return i;
            				}
            			}
            		}
...
void Achievements_obj::loadAchievements(){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_58_loadAchievements)
HXDLIN(  58)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data )) {
HXLINE(  59)			if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("achievementsMap",d8,6f,d5,91),::hx::paccDynamic) )) {
HXLINE(  60)				::Achievements_obj::achievementsMap = ( ( ::haxe::ds::StringMap)(::flixel::FlxG_obj::save->data->__Field(HX_("achievementsMap",d8,6f,d5,91),::hx::paccDynamic)) );
            			}
...
HXLINE(  65)				{
HXLINE(  65)					int _g = 0;
HXDLIN(  65)					int _g1 = savedStuff->length;
HXDLIN(  65)					while((_g < _g1)){
HXLINE(  65)						_g = (_g + 1);
HXDLIN(  65)						int i = (_g - 1);
HXLINE(  66)						::Achievements_obj::achievementsMap->set(savedStuff->__get(i),true);
            					}
            				}
            			}
HXLINE(  69)			bool _hx_tmp;
HXDLIN(  69)			if ((::Achievements_obj::henchmenDeath == 0)) {
HXLINE(  69)				_hx_tmp = ::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("henchmenDeath",f4,76,2a,dd),::hx::paccDynamic) );
            			}
            			else {
HXLINE(  69)				_hx_tmp = false;
            			}
HXDLIN(  69)			if (_hx_tmp) {
HXLINE(  70)				::Achievements_obj::henchmenDeath = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("henchmenDeath",f4,76,2a,dd),::hx::paccDynamic)) );
            			}
            		}
            	}
