...
HX_DEFINE_STACK_FRAME(_hx_pos_f8fd466029c4d025_726_new,"ModMetadata","new",0x98e8f1a3,"ModMetadata.new","ModsMenuState.hx",726,0xc380473d)

void ModMetadata_obj::__construct(::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_f8fd466029c4d025_726_new)
HXLINE( 727)		this->folder = folder;
HXLINE( 728)		this->name = folder;
HXLINE( 729)		this->description = HX_("No description provided.",88,46,cb,66);
HXLINE( 730)		this->color = ::ModsMenuState_obj::defaultColor;
HXLINE( 731)		this->restart = false;
HXLINE( 734)		::String key = (folder + HX_("/pack.json",ce,a9,3a,e3));
HXDLIN( 734)		if (::hx::IsNull( key )) {
HXLINE( 734)			key = HX_("",00,00,00,00);
            		}
HXDLIN( 734)		::String path = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 735)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 736)			::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 737)			bool _hx_tmp;
HXDLIN( 737)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 737)				_hx_tmp = (rawJson.length > 0);
            			}
            			else {
HXLINE( 737)				_hx_tmp = false;
            			}
HXDLIN( 737)			if (_hx_tmp) {
HXLINE( 738)				 ::Dynamic stuff =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 740)				::Array< int > colors = ( (::Array< int >)(::Reflect_obj::getProperty(stuff,HX_("color",63,71,5c,4a))) );
HXLINE( 741)				::String description = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("description",fc,08,1d,5f))) );
HXLINE( 742)				::String name = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("name",4b,72,ff,48))) );
HXLINE( 743)				bool restart = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("restart",cf,c7,a5,6a))) );
HXLINE( 745)				bool _hx_tmp;
HXDLIN( 745)				if (::hx::IsNotNull( name )) {
HXLINE( 745)					_hx_tmp = (name.length > 0);
            				}
            				else {
HXLINE( 745)					_hx_tmp = false;
            				}
HXDLIN( 745)				if (_hx_tmp) {
HXLINE( 747)					this->name = name;
            				}
HXLINE( 749)				bool _hx_tmp1;
HXDLIN( 749)				if (::hx::IsNotNull( description )) {
HXLINE( 749)					_hx_tmp1 = (description.length > 0);
            				}
            				else {
HXLINE( 749)					_hx_tmp1 = false;
            				}
HXDLIN( 749)				if (_hx_tmp1) {
HXLINE( 751)					this->description = description;
            				}
HXLINE( 753)				bool _hx_tmp2;
HXDLIN( 753)				if (::hx::IsNotNull( colors )) {
HXLINE( 753)					_hx_tmp2 = (colors->length > 2);
            				}
            				else {
HXLINE( 753)					_hx_tmp2 = false;
            				}
HXDLIN( 753)				if (_hx_tmp2) {
HXLINE( 755)					int Red = colors->__get(0);
HXDLIN( 755)					int Green = colors->__get(1);
HXDLIN( 755)					int Blue = colors->__get(2);
HXDLIN( 755)					int Alpha = 255;
HXDLIN( 755)					int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 755)					{
HXLINE( 755)						color = (color & -16711681);
HXDLIN( 755)						int color1;
HXDLIN( 755)						if ((Red > 255)) {
HXLINE( 755)							color1 = 255;
            						}
            						else {
HXLINE( 755)							if ((Red < 0)) {
HXLINE( 755)								color1 = 0;
...
HXLINE( 755)								color1 = Red;
            							}
            						}
HXDLIN( 755)						color = (color | (color1 << 16));
            					}
HXDLIN( 755)					{
HXLINE( 755)						color = (color & -65281);
HXDLIN( 755)						int color2;
HXDLIN( 755)						if ((Green > 255)) {
HXLINE( 755)							color2 = 255;
            						}
            						else {
HXLINE( 755)							if ((Green < 0)) {
HXLINE( 755)								color2 = 0;
            							}
            							else {
HXLINE( 755)								color2 = Green;
            							}
            						}
HXDLIN( 755)						color = (color | (color2 << 8));
            					}
HXDLIN( 755)					{
HXLINE( 755)						color = (color & -256);
HXDLIN( 755)						int color3;
HXDLIN( 755)						if ((Blue > 255)) {
HXLINE( 755)							color3 = 255;
            						}
            						else {
HXLINE( 755)							if ((Blue < 0)) {
HXLINE( 755)								color3 = 0;
            							}
            							else {
HXLINE( 755)								color3 = Blue;
            							}
            						}
HXDLIN( 755)						color = (color | color3);
            					}
HXDLIN( 755)					{
HXLINE( 755)						color = (color & 16777215);
HXDLIN( 755)						int color4;
HXDLIN( 755)						if ((Alpha > 255)) {
HXLINE( 755)							color4 = 255;
            						}
            						else {
HXLINE( 755)							if ((Alpha < 0)) {
HXLINE( 755)								color4 = 0;
            							}
            							else {
HXLINE( 755)								color4 = Alpha;
            							}
            						}
HXDLIN( 755)						color = (color | (color4 << 24));
            					}
HXDLIN( 755)					this->color = color;
            				}
HXLINE( 758)				this->restart = restart;
            			}
            		}
            	}
