...
HXDLIN( 386)							_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_siblings/vlc/VlcBitmap.hx",7e,58,b4,13),386,HX_("vlc.VlcBitmap",db,f8,af,7f),HX_("render",56,6b,29,05)));
...
HXLINE( 426)		::haxe::Log_obj::trace(HX_("buffering",e2,6f,8f,b1),::hx::SourceInfo(HX_("source_siblings/vlc/VlcBitmap.hx",7e,58,b4,13),426,HX_("vlc.VlcBitmap",db,f8,af,7f),HX_("statusOnBuffering",b1,cc,37,e1)));
...
HXLINE( 502)		::haxe::Log_obj::trace(HX_("VLC ERROR - File not found?",f0,48,ee,fd),::hx::SourceInfo(HX_("source_siblings/vlc/VlcBitmap.hx",7e,58,b4,13),502,HX_("vlc.VlcBitmap",db,f8,af,7f),HX_("statusOnError",17,d5,f1,06)));
