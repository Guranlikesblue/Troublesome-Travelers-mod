...
HXLINE(  18)		::haxe::Log_obj::trace(HX_("Discord Client starting...",0d,5b,39,a8),::hx::SourceInfo(HX_("source_siblings/Discord.hx",6c,ef,66,c8),18,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
...
HXLINE(  25)		::haxe::Log_obj::trace(HX_("Discord Client started.",8e,09,8e,36),::hx::SourceInfo(HX_("source_siblings/Discord.hx",6c,ef,66,c8),25,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
...
HXDLIN(  54)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source_siblings/Discord.hx",6c,ef,66,c8),54,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
HXDLIN(  59)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source_siblings/Discord.hx",6c,ef,66,c8),59,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
HXLINE(  68)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("source_siblings/Discord.hx",6c,ef,66,c8),68,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
