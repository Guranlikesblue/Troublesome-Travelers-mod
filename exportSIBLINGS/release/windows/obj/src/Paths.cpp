...
HXLINE( 354)		::haxe::Log_obj::trace(HX_("oh no its returning null NOOOO",93,c9,d3,00),::hx::SourceInfo(HX_("source_siblings/Paths.hx",aa,b0,74,67),354,HX_("Paths",0e,7b,84,50),HX_("returnGraphic",d8,d3,95,0b)));
