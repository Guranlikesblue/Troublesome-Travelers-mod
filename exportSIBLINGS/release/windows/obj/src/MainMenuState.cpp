...
HXLINE( 164)		::haxe::Log_obj::trace(HX_("Giving achievement \"friday_night_play\"",e6,1b,7d,1f),::hx::SourceInfo(HX_("source_siblings/MainMenuState.hx",3f,8e,d1,26),164,HX_("MainMenuState",59,88,5e,20),HX_("giveAchievement",1e,ea,83,24)));
            	}
...
HXLINE( 268)			spr->set_x((spr->x + 250));
            		}
...
HXLINE( 293)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 293)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 293)				_gthis1->setPosition(_hx_tmp,(spr->getGraphicMidpoint(null())->y - add));
HXLINE( 294)				spr->centerOffsets(null());
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
