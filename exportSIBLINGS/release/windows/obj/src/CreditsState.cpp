...
static const ::String _hx_array_data_3b81c5b7_9[] = {
	HX_("Mod Team",fb,5a,50,dc),
};
static const ::String _hx_array_data_3b81c5b7_10[] = {
	HX_("Guranlikesblue",65,99,cb,49),HX_("guranlikesblue",45,05,76,9f),HX_("Director, Owner, Main Artist/Animator",cf,d9,e9,22),HX_("https://twitter.com/Guranlikesblue",5d,2b,23,ac),HX_("0000FF",40,11,3c,f4),
};
static const ::String _hx_array_data_3b81c5b7_11[] = {
	HX_("Nate the GoombaBoss",5d,9a,7c,28),HX_("nate-the-goombaboss",57,81,a7,04),HX_("Voice Actor",c7,d5,bf,30),HX_("https://discord.com/channels/982255991305412649/982255991762608198",16,1b,fb,ec),HX_("d2691e",65,07,96,e9),
};
...
HXLINE(  81)		::Array< ::Dynamic> pisspoop = ::Array_obj< ::Dynamic>::__new(24)->init(0,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_9,1))->init(1,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_10,5))->init(2,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_11,5))->init(3,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_12,1))->init(4,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_13,1))->init(5,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_14,5))->init(6,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_15,1))->init(7,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_16,1))->init(8,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_17,5))->init(9,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_18,5))->init(10,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_19,5))->init(11,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_20,1))->init(12,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_21,1))->init(13,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_22,5))->init(14,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_23,5))->init(15,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_24,5))->init(16,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_25,5))->init(17,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_26,5))->init(18,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_27,1))->init(19,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_28,1))->init(20,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_29,5))->init(21,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_30,5))->init(22,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_31,5))->init(23,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_32,5));
HXLINE( 108)		{
...
HXLINE( 147)		 ::flixel::text::FlxText _hx_tmp1 = this->descText;
...
HXDLIN( 147)		_hx_tmp1->setFormat(_hx_tmp2,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
...
HXLINE( 152)		 ::flixel::FlxSprite _hx_tmp3 = this->bg;
HXDLIN( 152)		_hx_tmp3->set_color(( (int)(this->getCurrentBGColor()) ));
