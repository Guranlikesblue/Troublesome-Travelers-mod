...
static const ::String _hx_array_data_3b81c5b7_9[] = {
	HX_("Mod Creater",58,62,87,8e),
};
static const ::String _hx_array_data_3b81c5b7_10[] = {
	HX_("Guranlikesblue",65,99,cb,49),HX_("guranlikesblue",45,05,76,9f),HX_("Main Programmer/Artist/Animator/ideas",0a,25,ca,7c),HX_("https://twitter.com/Guranlikesblue",5d,2b,23,ac),HX_("0000FF",40,11,3c,f4),
};
static const ::String _hx_array_data_3b81c5b7_11[] = {
	HX_("",00,00,00,00),
};
static const ::String _hx_array_data_3b81c5b7_12[] = {
	HX_("Mod Contributors",96,4c,e9,f1),
};
static const ::String _hx_array_data_3b81c5b7_13[] = {
	HX_("Eucalyptus7",7a,31,98,93),HX_("eucalyptus7",9a,99,65,af),HX_("Created The Song of Week1",f8,e2,11,73),HX_("https://coconala.com/users/2459595",b7,55,c9,40),HX_("89CFF0",0e,ec,51,62),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_158_update,"CreditsState","update",0x5b614be0,"CreditsState.update","CreditsState.hx",158,0xdb40a967)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_209_changeSelection,"CreditsState","changeSelection",0x5dc3e005,"CreditsState.changeSelection","CreditsState.hx",209,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_231_getCurrentBGColor,"CreditsState","getCurrentBGColor",0xd6c58504,"CreditsState.getCurrentBGColor","CreditsState.hx",231,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_240_unselectableCheck,"CreditsState","unselectableCheck",0x4473c3a2,"CreditsState.unselectableCheck","CreditsState.hx",240,0xdb40a967)
...
HXLINE(  81)		::Array< ::Dynamic> pisspoop = ::Array_obj< ::Dynamic>::__new(23)->init(0,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_9,1))->init(1,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_10,5))->init(2,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_11,1))->init(3,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_12,1))->init(4,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_13,5))->init(5,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_14,1))->init(6,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_15,1))->init(7,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_16,5))->init(8,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_17,5))->init(9,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_18,5))->init(10,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_19,1))->init(11,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_20,1))->init(12,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_21,5))->init(13,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_22,5))->init(14,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_23,5))->init(15,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_24,5))->init(16,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_25,5))->init(17,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_26,1))->init(18,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_27,1))->init(19,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_28,5))->init(20,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_29,5))->init(21,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_30,5))->init(22,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_31,5));
HXLINE( 107)		{
HXLINE( 107)			int _g2 = 0;
HXDLIN( 107)			while((_g2 < pisspoop->length)){
HXLINE( 107)				::Array< ::String > i = pisspoop->__get(_g2).StaticCast< ::Array< ::String > >();
HXDLIN( 107)				_g2 = (_g2 + 1);
HXLINE( 108)				this->creditsStuff->push(i);
            			}
            		}
HXLINE( 111)		{
HXLINE( 111)			int _g3 = 0;
HXDLIN( 111)			int _g4 = this->creditsStuff->length;
HXDLIN( 111)			while((_g3 < _g4)){
HXLINE( 111)				_g3 = (_g3 + 1);
HXDLIN( 111)				int i = (_g3 - 1);
HXLINE( 113)				bool isSelectable = !(this->unselectableCheck(i));
HXLINE( 114)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)((70 * i)) ),this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(0),!(isSelectable),false,null(),null());
HXLINE( 115)				optionText->isMenuItem = true;
HXLINE( 116)				optionText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 117)				 ::Alphabet optionText1 = optionText;
HXDLIN( 117)				optionText1->yAdd = (optionText1->yAdd - ( (Float)(70) ));
HXLINE( 118)				if (isSelectable) {
HXLINE( 119)					optionText->set_x((optionText->x - ( (Float)(70) )));
            				}
HXLINE( 121)				optionText->forceX = optionText->x;
HXLINE( 123)				optionText->targetY = ( (Float)(i) );
HXLINE( 124)				this->grpOptions->add(optionText).StaticCast<  ::Alphabet >();
HXLINE( 126)				if (isSelectable) {
HXLINE( 127)					if (::hx::IsNotNull( this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(5) )) {
HXLINE( 129)						::Paths_obj::currentModDirectory = this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(5);
            					}
HXLINE( 132)					 ::AttachedSprite icon =  ::AttachedSprite_obj::__alloc( HX_CTX ,(HX_("credits/",d5,48,ee,de) + this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(1)),null(),null(),null());
HXLINE( 133)					icon->xAdd = (optionText->get_width() + 10);
HXLINE( 134)					icon->sprTracker = optionText;
HXLINE( 137)					this->iconArray->push(icon);
HXLINE( 138)					this->add(icon);
HXLINE( 139)					::Paths_obj::currentModDirectory = HX_("",00,00,00,00);
HXLINE( 141)					if ((this->curSelected == -1)) {
HXLINE( 141)						this->curSelected = i;
            					}
            				}
            			}
            		}
HXLINE( 145)		this->descText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,50,600,1180,HX_("",00,00,00,00),32,null());
HXLINE( 146)		 ::flixel::text::FlxText _hx_tmp1 = this->descText;
HXDLIN( 146)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN( 146)		::String _hx_tmp2;
HXDLIN( 146)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 146)			_hx_tmp2 = file;
            		}
            		else {
HXLINE( 146)			_hx_tmp2 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN( 146)		_hx_tmp1->setFormat(_hx_tmp2,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 147)		this->descText->scrollFactor->set(null(),null());
HXLINE( 148)		this->descText->set_borderSize(((Float)2.4));
HXLINE( 149)		this->add(this->descText);
HXLINE( 151)		 ::flixel::FlxSprite _hx_tmp3 = this->bg;
HXDLIN( 151)		_hx_tmp3->set_color(( (int)(this->getCurrentBGColor()) ));
HXLINE( 152)		this->intendedColor = this->bg->color;
HXLINE( 153)		this->changeSelection(null());
HXLINE( 154)		this->super::create();
            	}


void CreditsState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_1bf4423a091ce525_158_update)
HXLINE( 159)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.7))) {
HXLINE( 161)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 161)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 164)		bool upP = ::PlayerSettings_obj::player1->controls->_ui_upP->check();
HXLINE( 165)		bool downP = ::PlayerSettings_obj::player1->controls->_ui_downP->check();
HXLINE( 167)		if (upP) {
HXLINE( 169)			this->changeSelection(-1);
            		}
HXLINE( 171)		if (downP) {
HXLINE( 173)			this->changeSelection(1);
            		}
HXLINE( 176)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 178)			if (::hx::IsNotNull( this->colorTween )) {
HXLINE( 179)				this->colorTween->cancel();
            			}
...
HXLINE( 182)			::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 184)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 185)			::CoolUtil_obj::browserLoad(this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(3));
            		}
...
HXDLIN( 191)		 ::CreditsState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 192)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 192)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 193)		while(true){
HXLINE( 194)			 ::CreditsState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 194)			_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 195)			if ((this->curSelected < 0)) {
HXLINE( 196)				this->curSelected = (this->creditsStuff->length - 1);
            			}
HXLINE( 197)			if ((this->curSelected >= this->creditsStuff->length)) {
HXLINE( 198)				this->curSelected = 0;
            			}
HXLINE( 193)			if (!(this->unselectableCheck(this->curSelected))) {
HXLINE( 193)				goto _hx_goto_33;
            			}
            		}
            		_hx_goto_33:;
HXLINE( 201)		int newColor = ( (int)(this->getCurrentBGColor()) );
HXLINE( 202)		if ((newColor != this->intendedColor)) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::CreditsState,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_209_changeSelection)
HXLINE( 209)				_gthis->colorTween = null();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 203)			if (::hx::IsNotNull( this->colorTween )) {
HXLINE( 204)				this->colorTween->cancel();
            			}
HXLINE( 206)			this->intendedColor = newColor;
HXLINE( 207)			this->colorTween = ::flixel::tweens::FlxTween_obj::color(this->bg,1,this->bg->color,this->intendedColor, ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("onComplete",f8,d4,7e,5d), ::Dynamic(new _hx_Closure_0(_gthis)))));
            		}
HXLINE( 214)		int bullShit = 0;
HXLINE( 216)		{
HXLINE( 216)			int _g = 0;
HXDLIN( 216)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 216)			while((_g < _g1->length)){
HXLINE( 216)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 216)				_g = (_g + 1);
HXLINE( 218)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 219)				bullShit = (bullShit + 1);
HXLINE( 221)				if (!(this->unselectableCheck((bullShit - 1)))) {
HXLINE( 222)					item->set_alpha(((Float)0.6));
HXLINE( 223)					if ((item->targetY == 0)) {
HXLINE( 224)						item->set_alpha(( (Float)(1) ));
            					}
            				}
            			}
            		}
HXLINE( 228)		this->descText->set_text(this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(2));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(CreditsState_obj,changeSelection,(void))
 ...
 ::Dynamic CreditsState_obj::getCurrentBGColor(){
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_231_getCurrentBGColor)
HXLINE( 232)		::String bgColor = this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(4);
HXLINE( 233)		if (!(::StringTools_obj::startsWith(bgColor,HX_("0x",48,2a,00,00)))) {
HXLINE( 234)			bgColor = (HX_("0xFF",88,89,15,20) + bgColor);
            		}
HXLINE( 236)		return ::Std_obj::parseInt(bgColor);
            	}
...
bool CreditsState_obj::unselectableCheck(int num){
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_240_unselectableCheck)
HXDLIN( 240)		return (this->creditsStuff->__get(num).StaticCast< ::Array< ::String > >()->length <= 1);
            	}
