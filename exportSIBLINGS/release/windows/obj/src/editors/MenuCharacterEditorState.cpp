...
HXLINE( 364)					::haxe::Log_obj::trace((HX_("Successfully loaded file: ",84,24,61,ed) + cutName),::hx::SourceInfo(HX_("source_siblings/editors/MenuCharacterEditorState.hx",01,9f,b7,52),364,HX_("editors.MenuCharacterEditorState",a2,06,38,48),HX_("onLoadComplete",be,4c,20,63)));
...
HXLINE( 392)		::haxe::Log_obj::trace(HX_("Cancelled file loading.",67,56,c5,a3),::hx::SourceInfo(HX_("source_siblings/editors/MenuCharacterEditorState.hx",01,9f,b7,52),392,HX_("editors.MenuCharacterEditorState",a2,06,38,48),HX_("onLoadCancel",3f,be,a2,45)));
            	}
...
HXLINE( 404)		::haxe::Log_obj::trace(HX_("Problem loading file",21,8c,56,d8),::hx::SourceInfo(HX_("source_siblings/editors/MenuCharacterEditorState.hx",01,9f,b7,52),404,HX_("editors.MenuCharacterEditorState",a2,06,38,48),HX_("onLoadError",a3,fa,a3,b0)));
            	}
