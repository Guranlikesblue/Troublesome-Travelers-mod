...
HXLINE(  57)			::haxe::Log_obj::trace((HX_("Error on .LUA script! ",17,d5,82,ba) + resultStr),::hx::SourceInfo(HX_("source_siblings/editors/EditorLua.hx",b6,bd,d9,01),57,HX_("editors.EditorLua",a3,65,49,99),HX_("new",60,d0,53,00)));
HXLINE(  58)			this->lua = null();
HXLINE(  59)			return;
            		}
HXLINE(  61)		::haxe::Log_obj::trace((HX_("Lua file loaded succesfully:",7f,6a,cb,37) + script),::hx::SourceInfo(HX_("source_siblings/editors/EditorLua.hx",b6,bd,d9,01),61,HX_("editors.EditorLua",a3,65,49,99),HX_("new",60,d0,53,00)));
