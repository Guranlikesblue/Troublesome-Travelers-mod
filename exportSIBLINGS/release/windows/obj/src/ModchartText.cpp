...
HX_DEFINE_STACK_FRAME(_hx_pos_552a6f94cb341f6a_2062_new,"ModchartText","new",0x58e3633b,"ModchartText.new","FunkinLua.hx",2062,0x00117937)

void ModchartText_obj::__construct(Float x,Float y,::String text,Float width){
            	HX_STACKFRAME(&_hx_pos_552a6f94cb341f6a_2062_new)
HXLINE(2064)		this->wasAdded = false;
HXLINE(2067)		super::__construct(x,y,width,text,16,null());
...
HXDLIN(2068)		this->setFormat(_hx_tmp,16,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(2069)		this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::PlayState_obj::instance->camHUD));
HXLINE(2070)		this->scrollFactor->set(null(),null());
HXLINE(2071)		this->set_borderSize(( (Float)(2) ));
            	}
