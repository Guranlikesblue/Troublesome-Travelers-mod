...
HX_DEFINE_STACK_FRAME(_hx_pos_ec6539926560d3c0_93_new,"AttachedAchievement","new",0x78b415bd,"AttachedAchievement.new","Achievements.hx",93,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_100_changeAchievement,"AttachedAchievement","changeAchievement",0x3f6c6afc,"AttachedAchievement.changeAchievement","Achievements.hx",100,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_105_reloadAchievementImage,"AttachedAchievement","reloadAchievementImage",0x2581b6a8,"AttachedAchievement.reloadAchievementImage","Achievements.hx",105,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_115_update,"AttachedAchievement","update",0x63d738cc,"AttachedAchievement.update","Achievements.hx",115,0xf249f7fa)

void AttachedAchievement_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::String name){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_93_new)
HXLINE(  94)		super::__construct(x,y,null());
HXLINE(  96)		this->changeAchievement(name);
HXLINE(  97)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            	}
...
void AttachedAchievement_obj::changeAchievement(::String tag){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_100_changeAchievement)
HXLINE( 101)		this->tag = tag;
HXLINE( 102)		this->reloadAchievementImage();
            	}
...
void AttachedAchievement_obj::reloadAchievementImage(){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_105_reloadAchievementImage)
HXLINE( 106)		if (::Achievements_obj::isAchievementUnlocked(this->tag)) {
HXLINE( 107)			::String library = null();
HXDLIN( 107)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic((HX_("achievements/",8b,5e,c1,17) + this->tag),library);
HXDLIN( 107)			this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
            		}
            		else {
HXLINE( 109)			::String library = null();
HXDLIN( 109)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("achievements/lockedachievement",ba,b8,0b,f8),library);
HXDLIN( 109)			this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
            		}
HXLINE( 111)		this->scale->set(((Float)0.7),((Float)0.7));
...
void AttachedAchievement_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_115_update)
HXLINE( 116)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE( 117)			this->setPosition((this->sprTracker->x - ( (Float)(130) )),(this->sprTracker->y + 25));
            		}
